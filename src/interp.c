...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "medit",          do_medit,       POS_DEAD,   8,  LOG_NORMAL, 0, 0,
0
},
...
0,0,0,},
    { "experience",            do_level,  POS_FIGHTING,      0,  LOG_NORMAL,
0,0,0},
...
LOG_NORMAL, 0,0,0},
    ...
    { "tongue",         do_tongue,  POS_FIGHTING,      3,  LOG_NORMAL, 8,DISC_VAMP_SERP,1},
...
0,0,0	},
    ...
    { "sacrifice",	do_sacrifice,	POS_SITTING,	 0,  LOG_NORMAL, 0,0,0	},
...
0, 0 },
      /* mage eq and monk eq commands lets those classes make items Aronacus */
    { "mageq",   	do_mageq,	POS_STANDING,    3,  LOG_NORMAL, 0,0,0 },
    //{ "monkeq",   do_monkeq,  POS_STANDING,    3,  LOG_NORMAL, 0,0, },
...
/* Vamp ^^^^ */
    ...
    { "code",           do_code,        POS_DEAD,     12,  LOG_NORMAL,0,0,0 },
...
8,DISC_VAMP_OBTE,1 },
    ...
    { "forge",		do_forge,	POS_STANDING,  2,  LOG_NORMAL,
0,0,0 },
...
*/
    ...
    { "darkheart",	do_darkheart,POS_STANDING,	 3,  LOG_NORMAL, 8,DISC_VAMP_SERP,5	},
...
8,DISC_VAMP_THAU,4 },   
    ...
    { "ninjagear", do_ninjagear,	POS_STANDING,    3,  LOG_NORMAL, 0,0,0 },
...
/*start drow section */
	...
	{ "drows",       do_drows,   POS_STANDING,     3,   LOG_NORMAL,   0,0,0 },
    ...
    { "scry",		do_scry,	 POS_FIGHTING,  3,  LOG_NORMAL, 0,0,0  },
...
/*demon section*/
	...
	// Demon warp stuff implemented by Aronacus
	{ "warps",     do_warps,	POS_STANDING,   3,  LOG_NORMAL, 1,0,0 },  // aron 
	{ "redeem",    do_redeem,   POS_STANDING,   3,  LOG_NORMAL, 1,0,0 },   //aron
	{ "obtain",    do_obtain,   POS_STANDING,   3,  LOG_NORMAL, 1,0,0  }, //aron
	/*end demon section*/
...
/* vamp protean healing*/
    ...
    { "serpent",		do_serpent,	POS_STANDING,	 3,  LOG_NORMAL, 8,DISC_VAMP_SERP,1	},   
    ...
    { "gifts",		do_gifts,	POS_SITTING,	 10,  LOG_NORMAL, 4,0,0	},
...
LOG_NORMAL, 0,0,0	},
   ...
   /* { "fileupdate",	do_fileupdate,POS_DEAD,		 12,  LOG_ALWAYS	},*/
    ...
    { "pmort",                do_pmort,     POS_DEAD,                12, LOG_ALWAYS, 0,0,0 }, 
...
0,0,0	},
    ...
    { "preturn",		do_preturn,	POS_DEAD,	 	 1,  LOG_NORMAL, 0,0,0	},
    ...
    { "echo",		do_echo,	POS_DEAD,	 	 8,  LOG_NORMAL, 0,0,0	},
    ...
    { "recho",		do_recho,	POS_DEAD,	 	 8,  LOG_NORMAL, 0,0,0	},
    ...
    { "system",                 do_system,      POS_DEAD,                7,  LOG_ALWAYS, 0,0,0  },
    { "pinfo",                  do_pinfo,       POS_DEAD,              12, LOG_ALWAYS, 0,0,0  },
...
0,0,0},
     ...
     * OLC 1.1b
     */
    { "aedit",          do_aedit,       POS_DEAD,    0,  LOG_NORMAL, 0, 0, 0 },
    { "redit",          do_redit,       POS_DEAD,    0,  LOG_NORMAL, 0, 0, 0 },
    { "oedit",          do_oedit,       POS_DEAD,    8,  LOG_NORMAL, 0, 0,
0
},
    { "asave",          do_asave,       POS_DEAD,    0,  LOG_NORMAL, 0, 0, 0 },
    { "alist",          do_alist,       POS_DEAD,    0,  LOG_NORMAL, 0, 0, 0 },
    { "resets",         do_resets,      POS_DEAD,    0,  LOG_NORMAL, 0, 0, 0 },
...
const	struct	social_type	social_table [] =
{
   ...
   {
   "girn",
   "You girn cause you're to damn stupid to grin.",
   "$n girns cause he's to stupid to grin.",
   "You girn at $M.",
   "$n girns at you. God they are a jerk.",
   "You girn at yourself. Are you really that stupid.",
   "$n girns at $mself.  $e must be a jackass."
   },
...
"You let out a low moan as $n runs the tip of $s tongue along the underside of your cock.",
       "I think not.",
       NULL,
         2, 0, 0, 5, 59, FALSE
},
...
},
{
	...
	"You reach up and cup your breasts, pulling on your nipples.",
	NULL,
	1, 0, 0, 1, 5, FALSE
    },
...
"$n rolls you onto all fours and penetrates your hot flesh from behind.  OoooOo.",
	"Not on yourself!",
	NULL,
	1, 1, 250, 25, 15, FALSE
    },
...
"$n slides $s fingers between your legs, gently stroking your clitoris.  MmmMmm.",
	"Not on yourself!",
	NULL,
	1, 0, 250, 0, 10, FALSE
    },
	...
	"$n grabs $s penis and begins to jerkoff for $N.",
...

	{
        ...
        "On whom do you wish to do this?",
        NULL,
        "You grab $S and tear her clothes off as you force your manhood in $S!",
        "$n grab $N and rapes her, don't watch!.",
    "$n grabs you and tears your clothes off and forces his manhood inside you!",
        "Not on yourself!",
        NULL,
        1, 1, 0, 25, 5, FALSE
    },
...
"$n gently twists your nipple between $s thumb and forefinger. It feels so good!",
	"Not on yourself!",
	NULL,
	1, 0, 0, 5, 10, FALSE
    },
...
//char buf2[MAX_STRING_LENGTH] ;
    ...
    if ( !IS_NPC(ch) && IS_SET(ch->extra, EXTRA_CODE) )
	do_code(ch, "");
    ...
    */ 
	...
	&&   cmd_table[cmd].level <= trust )
	{
		...
		if      (!str_cmp( cmd_table[cmd].name, "say"     )) found = TRUE;
                ...
                else if (!str_cmp( cmd_table[cmd].name, "system"  )) found = TRUE;
		...
		else if (!str_cmp( cmd_table[cmd].name, "pmort" )) found = TRUE;		
...
bool check_xsocial( CHAR_DATA *ch, char *command, char *argument )
{
    ...
    else if ((xsocial_table[cmd].gender == SEX_MALE) && (ch->sex != SEX_MALE))
    {
...
partner !=ch || !(partner = victim->pcdata->switchname) == "Susie") 
...
if ( 100 > ch->practice)
{
send_to_char("It costs 100 points of primal to create a Greater Klaive.\n\r",ch);
return;
}
ch->practice   -= 100;
obj = create_object(get_obj_index(29734)  ,0 );
if (IS_SET(obj->quest, QUEST_ARTIFACT))
REMOVE_BIT(obj->quest, QUEST_ARTIFACT);
if (IS_SET(obj->quest, SITEM_WOLFWEAPON))
REMOVE_BIT(obj->quest, SITEM_WOLFWEAPON);
if (IS_SET(obj->quest, QUEST_RELIC))
REMOVE_BIT(obj->quest, QUEST_RELIC);
obj_to_char(obj, ch);
act("A Greater Klaive appears in your hands in a flash of moon light.",ch,NULL,NULL,TO_CHAR);
act("A Greater Klaive appears in $n's hands in a flash of moon light.",ch,NULL,NULL,TO_ROOM);
return;
}
