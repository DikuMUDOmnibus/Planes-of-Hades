 ...
 */
    ...
    {
        "phantoms shade",        1,
        spell_phantoms_shade,    TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,			 SLOT(206),	5,	12,
        "",			 "You feel Phantom's shade leave you."
    },   
   
    {
        "aura of mistriss",	12,
	spell_aura_of_mistriss,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
	NULL,			SLOT(207),      5,      12,
	"",			"You feel the aura of Mistriss leave you."
