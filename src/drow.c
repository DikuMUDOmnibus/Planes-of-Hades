...
void do_grant( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char("Drowfire (2,500),  Darkness (7,500),  Drowpoison (2,500).\n\r",ch);
	send_to_char("Drowsight (5,000),  Drowshield (5,000),  Levitation (1,000).\n\r", ch );
	send_to_char("Shadowwalk (10,000),  Garotte (5,000),  Spiderarms (7,500).\n\r", ch );
	send_to_char("Drowhate (10,000),  Spiderform (15,000),  Web (5,000).\n\r",ch );
	send_to_char("Dgarotte (2,500),  Confuse (2,500),  Glamour (5,000).\n\r", ch );
	send_to_char("Earthshatter (7,500), Scry (10,000), Speed (7,500),  Toughskin (7,500).\n\r", ch );
  ...
  {		send_to_char( "They already have a profession.\n\r", ch );
	...
	{inpart = DPOWER_SCRY; cost =10000;}
	else
    {
	send_to_char("Please select a power from:\n\r",ch);
        send_to_char("Drowfire (2,500),  Darkness (7,500),  Drowpoison  (1,000).\n\r",ch);
	send_to_char("Drowsight (5,000),  Drowshield (5,000),  Levitation (1,000).\n\r", ch );
	send_to_char("Shadowwalk (10,000),  Garotte (5,000),  Spiderarms (7,500).\n\r", ch );
	send_to_char("Drowhate (10,000),  Spiderform (15,000),  Web (5,000).\n\r",ch );
	send_to_char("Dgarotte (2,500),  Confuse (2500),  Glamour (5,000).\n\r", ch);
	send_to_char("Earthshatter (7,500), Scry (10,000), Speed (7,500),  Toughskin (7,500).\n\r", ch );
